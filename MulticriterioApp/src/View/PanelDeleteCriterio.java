...
public class PanelDeleteCriterio extends JPanel {
	...
	public PanelDeleteCriterio(Controller control, String nameApp,String actionCancel, String mssChoose, String actionDelete) {
		lblNameApp = new JLabel(nameApp);

		btnAcceptOption = new ButtonGeneral("Accept ", 150, 30);
		btnAcceptOption.setActionCommand(actionDelete);
		btnAcceptOption.addActionListener(control);
		panelChooseForModify = new PanelChoose(mssChoose, null);
